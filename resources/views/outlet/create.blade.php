                ...
                <div class="row">
                    <div class="col col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="alamat" id="" cols="20" rows="5" class="form-control @error('alamat') is-invalid @enderror" placeholder="masukan alamat kamu"></textarea>
                            <div class="text-danger">
                                @error('alamat')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('tlp') is-invalid @enderror" name="tlp" placeholder="masukan nomor telepon">
                            <div class="text-danger">
                                @error('tlp')
                                {{ $message }}
                                @enderror
